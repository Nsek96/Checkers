...
public class CheckersWidow extends Application {
    ...
    private static TextField blackscore = new TextField("0");
    private static TextField redscore = new TextField("0");
    private static Scene scene;
    private static int rscore, bscore;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        blackscore.setLayoutX(10);
        blackscore.setLayoutY(70);
        blackscore.setDisable(true);
        redscore.setLayoutX(10);
        redscore.setLayoutY(300);
        redscore.setDisable(true);
        scene = new Scene(root, 900, 600);
        root.getChildren().addAll(board.newgamebtn, board.resignbtn, board.message, blackscore, redscore);
        ...
        public void makeMove(int fromRow, int fromCol, int toRow, int toCol) {
            ...
            if (fromRow - toRow == 2 || fromRow - toRow == -2) {
                if (currentPlayer == RED) {
                    rscore++;
                    redscore.setText(String.valueOf(rscore));
                }
